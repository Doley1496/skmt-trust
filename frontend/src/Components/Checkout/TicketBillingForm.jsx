...
export default function TicketBillingForm() {
  /* */
  ...
  const createBillingAddress = async (event) => {
    ...
    try {
      ...
      if (billingUserAddressLength > 0) {
        ...
        navigate("/ticketSummaryPage/?step=3");
  ...
  return (
    ...
    <Wrapper>
      ...
      <Grid container spacing={4} className="mb-[80px]">
        ...
        >
          <div className="p-5 py-[40px] cursor-pointer justify-center">
            {/* */}

            <AddressCard />

            {billingUserAddressLength === 1 ? (
              <Link to={"/ticketSummaryPage/?step=3"}>
                <Button
                  sx={{
                    mt: 2,
                    mb: 10,
